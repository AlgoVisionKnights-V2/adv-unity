...
using TMPro;
public abstract class SearchGraph : Algorithm // MonoBehaviour is the root class for Unity scripts
{
    ...
    public class Edge{
        ...
        public Edge(int id){
            ...
            edge = new GameObject().AddComponent(typeof(LineRenderer)) as LineRenderer;
        ...
        foreach(QueueCommand q in queue){
            ...
            switch(q.commandId){
                ...
                case Commands.UPDATE_MESSAGE:// update the displayed message
                    ...
                    break;
                case Commands.UPDATE_QUEUE_MESSAGE: // update Queue message
                    listText.text = q.message;
                    break;
                case Commands.UPDATE_VERTEX: // update active vertex
